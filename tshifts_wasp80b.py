...
output_file_path = './output_files/wasp80b_synth_scatter'+str(int(scatter))+'_ahead'+str(int(Ntransits_ahead))+'LDscenA_nircCadence.txt'
figure_output_path = './figures/wasp80b_synth_scatter'+str(int(scatter))+'_ahead'+str(int(Ntransits_ahead))+'LDscenA_nircCadence/'
array_output_path = './output_arrays/wasp80b_synth_scatter'+str(int(scatter))+'_ahead'+str(int(Ntransits_ahead))+'LDscenA_nircCadence'
...
lit_params = {
    ...
    't0':np.array([2456671.49615, 0.00004, 'days', 'Kokori+ 2022'],dtype=object),
    'P':np.array([3.06785271, 0.00000019, 'days', 'Kokori+ 2022'], dtype=object),
    'log10P':np.array([np.log10(3.06785271), ((c*0.00000019)/3.06785271), 'unitless', 'calculated'], dtype=object),
    'a':np.array([12.63, 0.13, 'Rs', 'Triaud+ 2015'], dtype=object),
    'log10a':np.array([np.log10(12.63), ((c*0.13)/ 12.63), 'unitless', 'calculated'], dtype=object),
    'RpRs':np.array([0.17137, 0.00039, 'unitless', 'Triaud+ 2015'], dtype=object),
    #'RpRs':np.array([0.1158, 0.0017, 'unitless', 'pre determined for this band'], dtype=object),
    'Rs':np.array([0.605, 0.048, 'Rsun', 'Gaia DR2'], dtype='object'),
    'Mp':np.array([0.538, 0.035, 'Mjupiter', 'Triaud+ 2015'], dtype='object'),
    'Teq':np.array([825., 19., 'K', 'Triaud+ 2015'], dtype='object'),
    'inc':np.array([89.02, 0.11, 'degrees', 'Triaud+ 2015'], dtype=object),
    'cosi':np.array([np.cos(89.02*(np.pi/180.)), np.sin(89.02*(np.pi/180.))*(0.11*(np.pi/180.)), 'unitless', 'calculated'], dtype=object),
    ...
    'T14':np.array([2.131, 0.0031, 'hours', 'Triaud+ 2015'], dtype=object)
}
