...
output_file_path = './output_files/wasp107b_synth_scatter'+str(int(scatter))+'_ahead'+str(int(Ntransits_ahead))+'LDscenC_nircCadence.txt'
figure_output_path = './figures/wasp107b_synth_scatter'+str(int(scatter))+'_ahead'+str(int(Ntransits_ahead))+'LDscenC_nircCadence/'
array_output_path = './output_arrays/wasp107b_synth_scatter'+str(int(scatter))+'_ahead'+str(int(Ntransits_ahead))+'LDscenC_nircCadence'
...
lit_params = {
    ...
    't0':np.array([2456680.3346, 0.0003, 'days', 'Kokori+ 2022'],dtype=object),
    'P':np.array([5.721488, 0.000003, 'days', 'Kokori+ 2022'], dtype=object),
    'log10P':np.array([np.log10(5.721488), ((c*0.000003)/5.721488), 'unitless', 'calculated'], dtype=object),
    'a':np.array([18.2, 0.1, 'Rs', 'Anderson + 2017'], dtype=object),
    'log10a':np.array([np.log10(18.2), ((c*0.1)/ 18.2), 'unitless', 'calculated'], dtype=object),
    'RpRs':np.array([0.14434, 0.00018, 'unitless', 'Dai & Winn 2017'], dtype=object),
    #'RpRs':np.array([0.1158, 0.0017, 'unitless', 'pre determined for this band'], dtype=object),
    'Rs':np.array([0.73, 0.15, 'Rsun', 'Gaia DR2'], dtype='object'),
    'Mp':np.array([0.096, 0.005, 'Mjupiter', 'Piaulet+ 2021'], dtype='object'),
    'Teq':np.array([770, 60., 'K', 'Anderson+ 2017'], dtype='object'),
    'inc':np.array([89.7, 0.2, 'degrees', 'Anderson+ 2017'], dtype=object),
    'cosi':np.array([np.cos(89.7*(np.pi/180.)), np.sin(89.7*(np.pi/180.))*(0.2*(np.pi/180.)), 'unitless', 'calculated'], dtype=object),
    ...
    'T14':np.array([2.753, 0.007, 'hours', 'Anderson+ 2017'], dtype=object)
}
...
#    Ndatapoints = 350    # number of light curve points
    tint = 18.85 # [seconds] per integration
    # generate time axis
