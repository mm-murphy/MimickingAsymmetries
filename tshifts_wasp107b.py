...
output_file_path = './output_files/wasp107b_synth_scatter'+str(int(scatter))+'_ahead'+str(int(Ntransits_ahead))+'LDscenA_nircCadence.txt'
figure_output_path = './figures/wasp107b_synth_scatter'+str(int(scatter))+'_ahead'+str(int(Ntransits_ahead))+'LDscenA_nircCadence/'
array_output_path = './output_arrays/wasp107b_synth_scatter'+str(int(scatter))+'_ahead'+str(int(Ntransits_ahead))+'LDscenA_nircCadence'
